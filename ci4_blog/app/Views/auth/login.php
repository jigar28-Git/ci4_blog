...
<h2 class="text-center h1 py-5" style="text-shadow: 4px 3px 0px #fff, 9px 8px 0px rgba(0,0,0,0.20)"><?= env('system_name') ?></h2>

<div class="col-lg-3 col-md-5 col-sm-10 col-xs-12">
    <div class="card rounded-0">
        <div class="card-header">
            <div class="card-title h2 mb-0 text-center" style="text-shadow: 4px 3px 0px #fff, 5px 6px 0px rgba(0,0,0,0.15)">Login</div>
        </div>
        <div class="card-body">
                ...
                <form action="<?= base_url('login') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-0">
                            <input type="email" class="form-control rounded-0" id="email" name="email" autofocus value="<?= !empty($data->getPost('email')) ? $data->getPost('email') : '' ?>" required="required">
