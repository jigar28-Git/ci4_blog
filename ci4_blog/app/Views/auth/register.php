...
<div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
    <div class="card rounded-0">
        <div class="card-header">
            <div class="card-title h4 mb-0 text-center" style="text-shadow: 4px 3px 0px #fff, 4px 5px 0px rgba(0,0,0,0.15)">Create New Account</div>
        </div>
        <div class="card-body">
                ...
                <form action="<?= base_url('register') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-0">
                            <input type="text" class="form-control rounded-0" id="name" name="name" autofocus value="<?= !empty($data->getPost('name')) ? $data->getPost('name') : '' ?>" required="required">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-0">
                            <input type="email" class="form-control rounded-0" id="email" name="email" value="<?= !empty($data->getPost('email')) ? $data->getPost('email') : '' ?>" required="required">
