...
<div class="row">
    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 pb-3">
        <div class="card shadow border-top-0 border-bottom-0 border-end-0 border-start-3 border-success" style="border-left-width: 5px;">
            <div class="card-body">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 pb-3">
        <div class="card shadow border-top-0 border-bottom-0 border-end-0 border-start-3 border-danger" style="border-left-width: 5px;">
            <div class="card-body">
                <div class="container-fluid py-3">
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 pb-3">
        <div class="card shadow border-top-0 border-bottom-0 border-end-0 border-start-3 border-primary" style="border-left-width: 5px;">
            <div class="card-body">
                <div class="container-fluid py-3">
