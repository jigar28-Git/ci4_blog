...
<div class="list-group" id="post-list">
    ...
    <a href="<?= base_url("Blog/view/".$row['id']) ?>" class="list-group-item list-group-item-action text-decoration-none text-reset post-item">
        <div class="d-flex w-100">
            <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 p-10">
                <div class="w-80 overflow-hidden" class="post-img-holder">
                    <img src="<?= $row['banner'] ?>" alt="<?= $row['title'] ?>" class="img-thumbnail border bg-dark post-img">
                </div>
            </div>
