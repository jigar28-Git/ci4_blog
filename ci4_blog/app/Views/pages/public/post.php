...
<div class="card shadow">
    <div class="card-header">
        <div class="text-end">
            <a href="<?= $_SERVER['HTTP_REFERER'] ?>" class="btn btn-sm btn-light border"><i class="fa fa-angle-left"></i> Back</a>
        </div>
    </div>
    <div class="card-body">
        <div class="container-fluid">
            ...
            <div class="d-flex w-100 justify-content-between">
                ...
                <div class="text-muted">
                    ...
                    <small class="me-3"><i class="farfa-clock"></i> <?= date("M d, Y h:i A", strtotime($post['updated_at'])) ?></small>
                </div>
            </div>
            <div class="py-3">
